...
// Create classes and their features
    ...
    m_Base01__valBase01->setFeatureID(::base::BasePackage::BASE01__VALBASE01);
    ...
    m_Base02__valBase02->setFeatureID(::base::BasePackage::BASE02__VALBASE02);
    static_cast< ::ecorecpp::mapping::ReferenceEListImpl<
    ...
    m_Base03__valBase03->setFeatureID(::base::BasePackage::BASE03__VALBASE03);
    static_cast< ::ecorecpp::mapping::ReferenceEListImpl<
