...
// Create classes and their features
    ...
    { // Contained
        m_ContainedEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // InterfaceDef
        ...
        m_InterfaceDef__isAbstract->basicsetEContainingClass(
        ...
        m_InterfaceDef__isCustom->basicsetEContainingClass(
                m_InterfaceDefEClass);
        ...
        m_InterfaceDef__derivesFrom->basicsetEContainingClass(
                m_InterfaceDefEClass);
    }

    { // ModuleDef
        m_ModuleDefEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // IDLType
        m_IDLTypeEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // OperationDef
        ...
        m_OperationDef__parameters->basicsetEContainingClass(
                m_OperationDefEClass);
        ...
        m_OperationDef__isOneway->basicsetEContainingClass(
                m_OperationDefEClass);
        ...
        m_OperationDef__contexts->basicsetEContainingClass(
                m_OperationDefEClass);
        ...
        m_OperationDef__canRaise->basicsetEContainingClass(
                m_OperationDefEClass);
    }
    ...
    { // AttributeDef
        ...
        m_AttributeDef__getRaises->basicsetEContainingClass(
                m_AttributeDefEClass);
        ...
        m_AttributeDef__setRaises->basicsetEContainingClass(
                m_AttributeDefEClass);
        ...
        m_AttributeDef__isReadonly->basicsetEContainingClass(
                m_AttributeDefEClass);
    }
    ...
    { // ConstantDef
        ...
        m_ConstantDef__constValue->basicsetEContainingClass(
                m_ConstantDefEClass);
    }
    ...
    { // ParameterDef
        ...
        m_ParameterDef__identifier->basicsetEContainingClass(
                m_ParameterDefEClass);
        ...
        m_ParameterDef__direction->basicsetEContainingClass(
                m_ParameterDefEClass);
    }
    ...
    { // ExceptionDef
        ...
        m_ExceptionDef__typeCode->basicsetEContainingClass(
                m_ExceptionDefEClass);
    ...
    { // FixedDef
        m_FixedDefEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // WstringDef
        m_WstringDefEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // StringDef
        m_StringDefEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // AliasDef
        m_AliasDefEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // ArrayDef
        m_ArrayDefEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // UnionField
        m_UnionFieldEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // TypedefDef
        m_TypedefDefEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // UnionDef
        m_UnionDefEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
        ...
        m_UnionDef__containedDiscrim->basicsetEContainingClass(
                m_UnionDefEClass);
    ...
    { // EnumDef
        m_EnumDefEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // StructDef
        m_StructDefEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // Include
        m_IncludeEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // ParameterMode
        m_ParameterModeEEnum = ::ecore::Ptr < ::ecore::EEnum
                > (new ::ecore::EEnum);
    ...
    { // PrimitiveKind
        m_PrimitiveKindEEnum = ::ecore::Ptr < ::ecore::EEnum
                > (new ::ecore::EEnum);
    ...
    { // ParameterMode
...

        {
            ...
            _el->setValue(m_ParameterModeEEnum->getELiterals().size());
    ...
    { // PrimitiveKind
...

        {
            ...
            // PK_NULL
            _el->setName("PK_NULL");
            _el->setValue(m_PrimitiveKindEEnum->getELiterals().size());
