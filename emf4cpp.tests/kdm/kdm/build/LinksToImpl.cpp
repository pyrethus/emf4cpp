        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::build::BuildPackage::LINKSTO__TO:
    {
        ...
        ::kdm::build::AbstractBuildElement_ptr _t1 = std::dynamic_pointer_cast
                < ::kdm::build::AbstractBuildElement > (_t0);
    ...
    case ::kdm::build::BuildPackage::LINKSTO__FROM:
    {
        ::ecore::EObject_ptr _t0 = ::ecorecpp::mapping::any::any_cast
                < ::ecore::EObject_ptr > (_newValue);
        ::kdm::build::SymbolicLink_ptr _t1 = std::dynamic_pointer_cast
                < ::kdm::build::SymbolicLink > (_t0);
