        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::data::DataPackage::DATATYPEOF__TO:
    {
        ...
        ::kdm::code::Datatype_ptr _t1 = std::dynamic_pointer_cast
                < ::kdm::code::Datatype > (_t0);
    ...
    case ::kdm::data::DataPackage::DATATYPEOF__FROM:
    {
        ::ecore::EObject_ptr _t0 = ::ecorecpp::mapping::any::any_cast
                < ::ecore::EObject_ptr > (_newValue);
        ::kdm::data::ComplexContentType_ptr _t1 = std::dynamic_pointer_cast
                < ::kdm::data::ComplexContentType > (_t0);
