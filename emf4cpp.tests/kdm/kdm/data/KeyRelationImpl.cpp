        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kdm::data::DataPackage::KEYRELATION__TO:
    {
        ...
        ::kdm::data::UniqueKey_ptr _t1 = std::dynamic_pointer_cast
                < ::kdm::data::UniqueKey > (_t0);
    ...
    case ::kdm::data::DataPackage::KEYRELATION__FROM:
    {
        ::ecore::EObject_ptr _t0 = ::ecorecpp::mapping::any::any_cast
                < ::ecore::EObject_ptr > (_newValue);
        ::kdm::data::ReferenceKey_ptr _t1 = std::dynamic_pointer_cast
                < ::kdm::data::ReferenceKey > (_t0);
