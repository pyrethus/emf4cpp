...
// Create classes and their features
    ...
    { // TextElement
        ...
        m_TextElement__textLength->basicsetEContainingClass(
                m_TextElementEClass);
    ...
    { // Ellipse
        m_EllipseEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // Polyline
        m_PolylineEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // Polygon
        m_PolygonEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // Transform
        m_TransformEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // Translate
        m_TranslateEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // Visibility
        m_VisibilityEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // FontWeight
        m_FontWeightEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // FontStyle
        m_FontStyleEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // Dimension
        m_DimensionEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
    ...
    { // ReferencedFile
        ...
        m_ReferencedFile__referer->basicsetEContainingClass(
                m_ReferencedFileEClass);
        ...
        m_ReferencedFile__name->basicsetEContainingClass(
                m_ReferencedFileEClass);
    }

    { // SvgFile
        m_SvgFileEClass = ::ecore::Ptr < ::ecore::EClass
                > (new ::ecore::EClass);
