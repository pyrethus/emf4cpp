        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::v_1_0::edate::EdatePackage::APOLLO11__MEMBER:
    {
        ...
        ::v_1_0::edate::Person_ptr _t1 =
                dynamic_cast< ::v_1_0::edate::Person* >(_t0.get()); /*/// std::dynamic_pointer_cast< ::v_1_0::edate::Person >(_t0);*/
...
::ecore::EClass_ptr Apollo11::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::v_1_0::edate::EdatePackage* >(::v_1_0::edate::EdatePackage::_instance().get())->getApollo11();
    return _eclass;
}
