        ...
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::v_2_0::edate::EdatePackage::PERSON__BIRTHDAY:
    {
        ...
        ::v_2_0::edate::Person::setBirthday(_t0);
    }
        return;
    case ::v_2_0::edate::EdatePackage::PERSON__NAME:
    {
        ...
        ::ecorecpp::mapping::any_traits < ::ecore::EString
                > ::fromAny(_newValue, _t0);
        ::v_2_0::edate::Person::setName(_t0);
    }
        return;
...
::ecore::EClass_ptr Person::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::v_2_0::edate::EdatePackage* >(::v_2_0::edate::EdatePackage::_instance().get())->getPerson();
    return _eclass;
}
